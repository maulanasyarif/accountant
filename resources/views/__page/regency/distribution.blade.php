            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Distribution') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card-body text-white">
                    <div class="d-flex flex-row">
                        ...
                        <div class="p-10 align-self-center">
                            <h4 class="m-b-0">Total Terdistribusi</h4>
                            <span>{{ __('Semua') }}</span>
                        </div>
                                                            ...
                                                            <div class="col-lg-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="direct_filter_name"
                                                                        ...
                                                                        class="form-control"
                                                                        placeholder="{{ __('Search Nama Kecamatan') }}"
                                                                        aria-label="{{ __('Search Nama Kecamatan') }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">{{ __('Tambah Distribusi') }}</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="">{{ __('Kecamatan') }}</label>
                        <select name="district_id" id="direct_filter_arrival" class="form-control" style="width: 100%;">
                            <option value="">-- {{ __('Kecamatan') }} --</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="">{{ __('Total DIstribusi') }}</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-info waves-effect"
                        id="btn_submit">{{ __('Simpan') }}</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
$("#export_pdf").click(function() {
    ...
    html2canvas($('#t_regencies')[0], {
        onrendered: function(canvas) {
            ...
            pdfMake.createPdf(docDefinition).download("Distribusi.pdf");
        }
    });
...
<script src="{{ asset('src/regency/distribution.js') }}"></script>
<script>
    DistributionController.init('{{ Session::get('admin-auth.token') }}');
</script>
@endsection