                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover data-table" id="t_Corporate">
                                        <thead class="thead-light">
                                            ...
                                            <tr>
                                                <td style="width: 50%;" id="id"><strong>{{ __('Corporate Name') }}</strong></td>
                                                <td style="width: 50%;" id="id"><strong>{{ __('Address') }}</strong></td>
                                                <td style="width: 50%;" id="id"><strong>{{ __('Email') }}</strong></td>
                                                <td style="width: 50%;" id="id"><strong>{{ __('Phone') }}</strong></td>
