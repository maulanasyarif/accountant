...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">{{ __('Perkiraan') }}</h4>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Perkiraan') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card-body text-white">
                    <div class="d-flex flex-row">
                        <div class="p-10 align-self-center">
                            <h4 class="m-b-0">Total Data Perkiraan</h4>
                            <span>{{ __('Semua') }}</span>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover data-table" id="t_perkiraan">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">{{ __('Tambah Perkiraan') }}</h4>
...
$("#export_pdf").click(function() {
    ...
    html2canvas($('#t_perkiraan')[0], {
        onrendered: function(canvas) {
            ...
            pdfMake.createPdf(docDefinition).download("Perkiraan.pdf");
        }
    });
...
<script src="{{ asset('src/admin/perkiraan.js') }}"></script>
<script>
