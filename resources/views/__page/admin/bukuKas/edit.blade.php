...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">{{ __('Detail Kas') }}</h4>
        </div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            <a href="{{ url('bukuKasAdmin') }}">{{ __('Buku Kas') }}</a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
<script src="{{ asset('src/admin/bukuKas.js') }}"></script>
<script>
    BukuKasController.detail('{{ Session::get('admin-auth.token')}}', {{ $id }});
</script> 
<script>
    BukuKasController.init('{{ Session::get('admin-auth.token')}}');
</script> 
@endsection