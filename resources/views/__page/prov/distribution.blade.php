                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover data-table" id="t_regencies">
                                        <thead class="thead-light">
                                            ...
                                            <tr>
                                                <td style="width: 50%;">
                                                    <strong>{{ __('Kota/Kabupaten') }}</strong>
                                                </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="">{{ __('Kota\Kabupaten') }}</label>
                        <select name="regency_id" id="direct_filter_arrival" class="form-control" style="width: 100%;">
                            <option value="">-- {{ __('Kota\Kabupaten') }} --</option>
                        </select>
                    </div>
...
<script src="{{ asset('src/prov/distribution.js') }}"></script>
<script>
