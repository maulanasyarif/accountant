            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a href="{{ route('regency') }}">{{ __('Regency') }}</a>
                        </li>
                ...
                <div class="card-body text-white">
                    <div class="d-flex flex-row">
                        ...
                        <div class="ml-auto align-self-center">
                            <h2 class="font-medium m-b-0" id="count_districts">0</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover data-table" id="t_districts">
                                        <thead class="thead-light">
                                            ...
                                            <tr>
                                                <td style="width: 50%;" id="id"><strong>{{ __('Kecamatan') }}</strong>
                                                </td>
                                            </tr>
                                        </thead>
                                        <tbody>
...
<script src="{{ asset('src/prov/districts.js') }}"></script>
<script>
    DistrictsController.init('{{ Session::get('admin-auth.token') }}');
</script>
<script src="{{ asset('src/prov/regency.js') }}"></script>
<script>
    DistrictsController.detail('{{ Session::get('admin-auth.token') }}', {{ $id }});
</script>
@endsection()